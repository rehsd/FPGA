...
##to support the SR latch for ResetState
##set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets SixteenBit_Processor_BD_i/ResetStateLatch_0/U0/Q_INST_0_i_1_n_0]
...
## Clock Signal
#set_property -dict { PACKAGE_PIN H16    IOSTANDARD LVCMOS33 } [get_ports { sys_clk_i }]; #IO_L13P_T2_MRCC_35 Sch=SYSCLK
...
set_property -dict { PACKAGE_PIN P14    IOSTANDARD LVCMOS33 } [get_ports { Reset }]; #IO_L6P_T0_34 Sch=LED1
set_property -dict { PACKAGE_PIN N16    IOSTANDARD LVCMOS33 } [get_ports { LED_Reset }]; #IO_L21N_T3_DQS_AD14N_35 Sch=LED2
set_property -dict { PACKAGE_PIN M14    IOSTANDARD LVCMOS33 } [get_ports { LED_ResetWithoutRAM }]; #IO_L23P_T3_35 Sch=LED3
...
set_property -dict { PACKAGE_PIN L20    IOSTANDARD LVCMOS33 } [get_ports { ResetButtonIn }]; #IO_L9N_T1_DQS_AD3N_35 Sch=BTN2
set_property -dict { PACKAGE_PIN L19    IOSTANDARD LVCMOS33 } [get_ports { ResetWithoutRAMButtonIn }]; #IO_L9P_T1_DQS_AD3P_35 Sch=BTN3
...
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { jb[4] }]; #IO_L18P_T2_34 Sch=JB3_P (Pin 7)
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { jb[5] }]; #IO_L18N_T2_34 Sch=JB3_N (Pin 8)
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { jb[6] }]; #IO_L4P_T0_34 Sch=JB4_P (Pin 9)
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { jb[7] }]; #IO_L4N_T0_34 Sch=JB4_N (Pin 10)
