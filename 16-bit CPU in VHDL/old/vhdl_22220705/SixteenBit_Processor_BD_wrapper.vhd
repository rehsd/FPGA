...
entity SixteenBit_Processor_BD_wrapper is
  port (
    ...
    LED_ResetWithoutRAM : out STD_LOGIC;
    Reset : out STD_LOGIC;
    ResetButtonIn : in STD_LOGIC;
    ResetWithoutRAMButtonIn : in STD_LOGIC;
...
SixteenBit_Processor_BD_i: component SixteenBit_Processor_BD
     port map (
      ...
      LED_Reset => LED_Reset,
      LED_ResetWithoutRAM => LED_ResetWithoutRAM,
      Reset => Reset,
      ResetButtonIn => ResetButtonIn,
      ResetWithoutRAMButtonIn => ResetWithoutRAMButtonIn,
