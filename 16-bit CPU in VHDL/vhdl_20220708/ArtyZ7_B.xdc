...
set_property -dict { PACKAGE_PIN M14    IOSTANDARD LVCMOS33 } [get_ports { LED_Reset }]; #IO_L23P_T3_35 Sch=LED3
...
set_property -dict { PACKAGE_PIN L19    IOSTANDARD LVCMOS33 } [get_ports { ResetButtonIn }]; #IO_L9P_T1_DQS_AD3P_35 Sch=BTN3
