...
void UpdateDebugInfo()
{
	//Debug - display misc. signals
	u32 dbg = gpio1_ch2_status&1073741824;
	dbg = dbg>>30;

	if(dbg&1)
	{
		OLEDrgb_DrawRectangle(&oledrgb, 32,48,34,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(255,255,255));
	}
	else
	{
		OLEDrgb_DrawRectangle(&oledrgb, 32,48,34,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(0,0,0));
	}
	...
	{
		OLEDrgb_DrawRectangle(&oledrgb, 41,48,43,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(255,255,255));
	}
	else
	{
		OLEDrgb_DrawRectangle(&oledrgb, 41,48,43,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(0,0,0));
	}
	if(currentControlADDR&64)
	{
		OLEDrgb_DrawRectangle(&oledrgb, 44,48,46,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(255,255,255));
	}
	else
	{
		OLEDrgb_DrawRectangle(&oledrgb, 44,48,46,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(0,0,0));
	}
	if(currentControlADDR&32)
	{
		OLEDrgb_DrawRectangle(&oledrgb, 47,48,49,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(255,255,255));
	}
	else
	{
		OLEDrgb_DrawRectangle(&oledrgb, 47,48,49,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(0,0,0));
	}
	if(currentControlADDR&16)
	{
		OLEDrgb_DrawRectangle(&oledrgb, 50,48,52,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(255,255,255));
	}
	else
	{
		OLEDrgb_DrawRectangle(&oledrgb, 50,48,52,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(0,0,0));
	}
	if(currentControlADDR&8)
	{
		OLEDrgb_DrawRectangle(&oledrgb, 53,48,55,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(255,255,255));
	}
	else
	{
		OLEDrgb_DrawRectangle(&oledrgb, 53,48,55,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(0,0,0));
	}
	if(currentControlADDR&4)
	{
		OLEDrgb_DrawRectangle(&oledrgb, 56,48,58,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(255,255,255));
	}
	else
	{
		OLEDrgb_DrawRectangle(&oledrgb, 56,48,58,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(0,0,0));
	}
	if(currentControlADDR&2)
	{
		OLEDrgb_DrawRectangle(&oledrgb, 59,48,61,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(255,255,255));
	}
	else
	{
		OLEDrgb_DrawRectangle(&oledrgb, 59,48,61,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(0,0,0));
	}
	if(currentControlADDR&1)
	{
		OLEDrgb_DrawRectangle(&oledrgb, 62,48,64,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(255,255,255));
	}
	else
	{
		OLEDrgb_DrawRectangle(&oledrgb, 62,48,64,56, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(0,0,0));
	}
...
//	u32 instrAddr = gpio1_ch1_status&MASK_INST_STEP;
//
//	//address bits are left four bits
//	if(instrAddr&128)
//	{
//		OLEDrgb_DrawRectangle(&oledrgb, 0,24,2,30, OLEDrgb_BuildRGB(50,50,200), 1 ,OLEDrgb_BuildRGB(255,255,255));
//	}
//	else
//	{
//		OLEDrgb_DrawRectangle(&oledrgb, 0,24,2,30, OLEDrgb_BuildRGB(50,50,200), 1 ,OLEDrgb_BuildRGB(0,0,0));
//	}
//	if(instrAddr&128)
//	{
//		OLEDrgb_DrawRectangle(&oledrgb, 3,24,5,30, OLEDrgb_BuildRGB(50,50,200), 1 ,OLEDrgb_BuildRGB(255,255,255));
//	}
//	else
//	{
//		OLEDrgb_DrawRectangle(&oledrgb, 3,24,5,30, OLEDrgb_BuildRGB(50,50,200), 1 ,OLEDrgb_BuildRGB(0,0,0));
//	}
//	if(instrAddr&128)
//	{
//		OLEDrgb_DrawRectangle(&oledrgb, 6,24,8,30, OLEDrgb_BuildRGB(50,50,200), 1 ,OLEDrgb_BuildRGB(255,255,255));
//	}
//	else
//	{
//		OLEDrgb_DrawRectangle(&oledrgb, 6,24,8,30, OLEDrgb_BuildRGB(50,50,200), 1 ,OLEDrgb_BuildRGB(0,0,0));
//	}
//	if(instrAddr&128)
//	{
//		OLEDrgb_DrawRectangle(&oledrgb, 9,24,11,30, OLEDrgb_BuildRGB(50,50,200), 1 ,OLEDrgb_BuildRGB(255,255,255));
//	}
//	else
//	{
//		OLEDrgb_DrawRectangle(&oledrgb, 9,24,11,30, OLEDrgb_BuildRGB(50,50,200), 1 ,OLEDrgb_BuildRGB(0,0,0));
//	}

	//next four bits (right) are the step
	//display these?
}
void UpdateInstructionRegister()
{
...
void UpdateControl()
{
	...
	if(control&2048)
	{
		OLEDrgb_DrawRectangle(&oledrgb, 12,56,14,62, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(255,255,255));
	}
	else
	{
		OLEDrgb_DrawRectangle(&oledrgb, 12,56,14,62, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(0,0,0));
	}
	if(control&1024)
	{
		OLEDrgb_DrawRectangle(&oledrgb, 15,56,17,62, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(255,255,255));
	}
	else
	{
		OLEDrgb_DrawRectangle(&oledrgb, 15,56,17,62, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(0,0,0));
	}
	if(control&512)
	{
		OLEDrgb_DrawRectangle(&oledrgb, 18,56,20,62, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(255,255,255));
	}
	else
	{
		OLEDrgb_DrawRectangle(&oledrgb, 18,56,20,62, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(0,0,0));
	}
	if(control&256)
	{
		OLEDrgb_DrawRectangle(&oledrgb, 21,56,23,62, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(255,255,255));
	}
	else
	{
		OLEDrgb_DrawRectangle(&oledrgb, 21,56,23,62, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(0,0,0));
	}
	if(control&128)
	{
	...
	if(control&8)
	{
		OLEDrgb_DrawRectangle(&oledrgb, 36,56,38,62, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(255,255,255));
	}
	else
	{
		OLEDrgb_DrawRectangle(&oledrgb, 36,56,38,62, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(0,0,0));
	}
	if(control&4)
	{
		OLEDrgb_DrawRectangle(&oledrgb, 39,56,41,62, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(255,255,255));
	}
	else
	{
		OLEDrgb_DrawRectangle(&oledrgb, 39,56,41,62, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(0,0,0));
	}
	if(control&2)
	{
		OLEDrgb_DrawRectangle(&oledrgb, 42,56,44,62, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(255,255,255));
	}
	else
	{
		OLEDrgb_DrawRectangle(&oledrgb, 42,56,44,62, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(0,0,0));
	}
	if(control&1)
	{
		OLEDrgb_DrawRectangle(&oledrgb, 45,56,47,62, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(255,255,255));
	}
	else
	{
		OLEDrgb_DrawRectangle(&oledrgb, 45,56,47,62, OLEDrgb_BuildRGB(20,20,20), 1 ,OLEDrgb_BuildRGB(0,0,0));
	}
}
void UpdateOutput()
{
