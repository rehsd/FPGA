...
void grabdata (int c, char** v)
{
    ...
    doomuwad = malloc(strlen(doomwaddir)+1+9+1);			//rehsd this was 1+8+1
...
int main(int c, char** v)
{
	...
	printf("soundsrv: main() starting\n");
    // get sound data
    grabdata(c, v);

    // init any data
    initdata();		
    printf("soundsrv: initdata() complete\n");

    I_InitSound(11025, 16);

    I_InitMusic();
    printf("soundsrv: I_InitMusic() complete\n");
