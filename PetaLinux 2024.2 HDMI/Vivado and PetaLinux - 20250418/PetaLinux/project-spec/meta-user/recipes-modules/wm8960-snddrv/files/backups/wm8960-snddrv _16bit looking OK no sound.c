                   ...
                   struct snd_pcm_hw_params *params)
{
    ...
    //ret = snd_soc_component_update_bits(codec_dai->component, WM8960_AUDIO_INTERFACE, 0x03 << 3, WM8960_I2S_FMT_24BIT);		//Audio Data Word Length: 24-bit *DEFAULT
    ret = snd_soc_component_update_bits(codec_dai->component, WM8960_AUDIO_INTERFACE, 0x03 << 3, WM8960_I2S_FMT_24BIT);			//Audio Data Word Length: 16-bit data
    if (ret < 0) {
    ...
    ret = snd_soc_dai_set_pll(codec_dai, WM8960_PLL1, 0, 24000000, pll_rate);
    if (ret < 0) {
