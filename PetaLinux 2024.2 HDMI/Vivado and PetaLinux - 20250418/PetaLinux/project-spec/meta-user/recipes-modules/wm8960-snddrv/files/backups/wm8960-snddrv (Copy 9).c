                   ...
                   struct snd_pcm_hw_params *params)
{
    ...
    ret = snd_soc_component_update_bits(codec_dai->component, WM8960_AUDIO_INTERFACE, 0x03 << 3, 0x02);		//Audio Data Word Length: 24-bit *DEFAULT
    //ret = snd_soc_component_update_bits(codec_dai->component, WM8960_AUDIO_INTERFACE, 0x03 << 3, 0x00);			//Audio Data Word Length: 16-bit data
    if (ret < 0) {
