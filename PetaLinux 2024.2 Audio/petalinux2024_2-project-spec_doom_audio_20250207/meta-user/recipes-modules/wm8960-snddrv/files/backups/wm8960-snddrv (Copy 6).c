                   ...
                   struct snd_pcm_hw_params *params)
{
    ...
    */
    ...
    /*
    // CLOCK DIVIDERS
    bclk_rate = sample_rate * ch * data_width;

    prv->mclk_ratio = 256;
    prv->mclk_val = prv->mclk_ratio * sample_rate;
    //clk_div = DIV_ROUND_UP(prv->mclk_ratio, 2 * ch * data_width);		//  =256 / (2*2*24) = 2.6667 = 3
    clk_div = mclk_rate / bclk_rate;										//  =12288000 / (48000*24) = 10.6667
